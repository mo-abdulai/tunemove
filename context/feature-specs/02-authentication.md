...
Add Clerk’s built-in `UserButton` to the dashboard navbar right section for profile settings and logout.
...
- `UserButton` appears in the dashboard navbar right section
- Clerk’s default profile and logout flows still work
- no gradients, oversized hero sections, feature cards, or scroll-heavy auth layouts were added
